            ...
            <div className="flex items-start justify-between p-3.5 bg-slate-50 dark:bg-slate-850 rounded-xl hover:bg-slate-100/50 dark:hover:bg-slate-800/40 transition-all border border-slate-100 dark:border-white/5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-550 dark:text-slate-400 leading-normal">Permite chamadas de voz encriptadas em tempo real entre o motorista e o passageiro via internet.</p>
                </div>
              </div>
              <button
                type="button"
                ...
                className={`relative inline-flex h-5 w-10 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                  webrtcEnabled ? 'bg-amber-500' : 'bg-slate-200 dark:bg-slate-700'
                }`}
              >
                <span
                  className={`pointer-events-none inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
